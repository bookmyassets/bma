            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-3">
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                  ...
                  <div className="prose prose-lg text-gray-700 space-y-6">
                    <p>
                      Dholera Special Investment Region (SIR) is India's first greenfield smart city, 
                      strategically located in Gujarat. Spanning over 920 square kilometers, it represents 
                      the future of urban development in India with world-class infrastructure and sustainable planning.
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 my-8">
                      ...
                      <div className="bg-gradient-to-r from-[#138808]/10 to-[#000080]/10 p-6 rounded-xl">
                        <h3 className="text-xl font-semibold text-gray-800 mb-3">Investment Benefits</h3>
                        <ul className="space-y-2 text-gray-700">
                    ...
                    <p>
                      Located near Ahmedabad and connected to major ports, Dholera SIR offers 
                      unparalleled investment opportunities in residential, commercial, and industrial sectors. 
                      The project is backed by the Gujarat government and follows international standards 
                    ...
                    <div className="bg-gradient-to-r from-[#FF9933]/5 via-white/50 to-[#138808]/5 p-8 rounded-xl border-l-4 border-[#FF9933]">
                      <h3 className="text-2xl font-semibold text-gray-800 mb-4">Why Invest in Dholera SIR?</h3>
                      <p className="text-gray-700 mb-4">
                        Dholera SIR presents a unique opportunity to be part of India's urban transformation. 
                        With planned infrastructure development, including metro connectivity, international airport, 
                        and smart utilities, it's positioned to become a major economic hub.
                      </p>
                      <div className="flex flex-wrap gap-3">
                        <span className="bg-[#FF9933]/20 text-[#FF9933] px-4 py-2 rounded-full text-sm font-semibold">
                          Smart Infrastructure
                        </span>
                        <span className="bg-[#138808]/20 text-[#138808] px-4 py-2 rounded-full text-sm font-semibold">
                          Strategic Location
                        </span>
                        <span className="bg-[#000080]/20 text-[#000080] px-4 py-2 rounded-full text-sm font-semibold">
                          Government Backed
                        </span>
                      </div>
                    </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8">
                    ...
                    {safePosts.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 text-sm">
                          Check back soon for the latest information about Dholera SIR investment opportunities.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  {/* Contact CTA */}
                  <div className="bg-gradient-to-r from-[#FF9933] to-[#138808] rounded-2xl p-6 mt-6 text-white">
                    <h4 className="text-xl font-bold mb-3">Ready to Invest?</h4>
                    <p className="text-sm mb-4 opacity-90">
                      Get expert guidance on Dholera SIR investment opportunities.
                    </p>
                    <button className="w-full bg-white text-gray-800 py-2 px-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                      Contact Us
                    </button>
                  </div>
                </div>
