...
export default function CostSheet() {
  ...
  useEffect(() => {
    if (formData.plotAreaYards && formData.basePlotPriceYards) {
      ...
      const totalCharges = maintenance + 20000 + ifmsCharge; // Legal Fee + IFMS
...
const submitToCRM = async () => {
  ...
  const generatePDF = async () => {
    ...
    const { name, phone, email, plc, plotNo, plotAreaYards, plotAreaFeet, totalPaymentYards, maintenanceRate, maintenanceCharge, ifms, totalCharges, plotTotalPayment } = formData;
