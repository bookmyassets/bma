...
export default function BMA() {
  ...
  return (
    <div className="bg-[#f9f9f9] ">
      <div className="flex flex-col  md:flex-row px-4 md:px-8 py-12 gap-6 md:gap-12 max-w-7xl mx-auto overflow-hidden">
        {/* Left Section (40%) */}
      ...
      <LeadForm title="Own Your Investor-Friendly Plot in Dholera - Starting under ₹10 Lakhs Only" />
    </div>
  );
}