...
export default function ProjectsSection() {
  return (
    ...
    >
      ...
      {/* Soft golden glow to visually separate section */}
      <div
        aria-hidden="true"
        className="
          pointer-events-none
          ...
          top-0
          h-[18rem]
          bg-[radial-gradient(ellipse_at_top,rgba(221,188,105,0.07),transparent_68%)]
        "
      />
          ...
          {projects.map((project) => (
            <article
              ...
              className="
                ...
                border-white/10
                bg-white/[0.04]
                shadow-[0_1.5rem_3rem_rgba(0,0,0,0.24)]
                transition-all
                duration-300
