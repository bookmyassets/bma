  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-[80rem] px-[clamp(1rem,4vw,2rem)] py-[clamp(2rem,5vw,3rem)]">
        ...
        <div className="mx-auto grid max-w-[42rem] grid-cols-1 gap-[clamp(1.25rem,3vw,2rem)] md:max-w-[76rem] md:grid-cols-2">
            ...
            >
              <div className="relative aspect-[4/3] w-full overflow-hidden">
                <Image
                  ...
                  alt={project.name}
                  fill
                  sizes="(max-width: 47.999rem) 100vw, 38rem"
              ...
              <div className="flex flex-1 flex-col p-[clamp(1rem,2vw,1.5rem)]">
                ...
                <h3 className="mb-[0.375rem] text-[clamp(1.25rem,2.2vw,1.75rem)] font-bold leading-[1.2] text-black">
                  {project.name}
                </h3>

                <p className="mb-[0.875rem] text-[clamp(0.9375rem,1.5vw,1.0625rem)] font-semibold leading-[1.45] text-[#deae3c]">
                  {project.subtext}
                </p>

                <p className="mb-[1rem] text-[clamp(0.875rem,1.3vw,1rem)] leading-[1.65] text-black">
                  {project.description}
                </p>
                ...
                <Link
                  href={project.href}
                  className="mt-auto inline-flex w-fit items-center gap-[0.5rem] rounded-full border-[0.0625rem] border-[#deae3c] px-[1rem] py-[0.5rem] text-[clamp(0.8125rem,1vw,0.9375rem)] font-semibold leading-none text-[#deae3c] transition-colors duration-200 hover:bg-[#deae3c] hover:text-white"
                >
