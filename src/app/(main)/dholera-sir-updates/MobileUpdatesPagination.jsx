...
export default function MobileUpdatesPagination({ children }) {
  ...
  if (totalPages <= 1) {
    return <div className="grid grid-cols-1 gap-6">{cards}</div>;
  }
    ...
    <div>
      ...
      >
        <button
          ...
          aria-label="Show previous updates page"
        >
          Prev
        </button>
        ...
        <button
          ...
          className="rounded-lg border border-gray-300 px-3 py-2 text-sm font-semibold text-black transition-colors disabled:cursor-not-allowed disabled:opacity-40"
          aria-label="Show next updates page"
        >
          Next
        </button>
      </nav>
