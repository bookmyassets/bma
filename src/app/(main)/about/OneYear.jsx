...
export default function BookMyAssets() {
  ...
  return (
    <>
      {/* Meet Our Founders */}
      <div className="bg-black min-h-screen py-16 px-4 md:px-6 flex flex-col items-center justify-center">
                  ...
                  <div className="grid md:grid-cols-1 gap-8">
                    <div>
                      ...
                      <p className="text-base text-gray-800 mb-3">
                        ...
                        five people started with one small cabin. We had no
                        fancy office, no big investors, just raw hunger and an
                        unshakable belief that we could build something
                        extraordinary in real estate. Most people called it
                        crazy. We called it destiny.
                        <br />
                        ...
                        too.
                        <br />
                        Year One was our audition. Year Two? That's where we
                        prove it was not luck. It was our hunger, heart, and
                        hustle.
                        <br />
                        <span className="font-bold">
