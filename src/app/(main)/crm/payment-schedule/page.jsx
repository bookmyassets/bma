...
const FIELDS = [
  ...
  { key: "m2DueTimeline",       label: "Due Timeline",      section: "Milestone 2", type: "text", readonly: true },
  { key: "m2PaymentDueDate",    label: "Payment Due Date",  section: "Milestone 2", type: "text", readonly: true },
  { key: "m3DueTimeline",       label: "Due Timeline",      section: "Milestone 3", type: "text", readonly: true },
  { key: "m3PaymentDueDate",    label: "Payment Due Date",  section: "Milestone 3", type: "text", readonly: true },
  { key: "totalDueTimeline",    label: "Due Timeline",      section: "Total", type: "text", readonly: true },
  { key: "totalPaymentDueDate", label: "Payment Due Date",  section: "Total", type: "text", readonly: true },
];
  ...
  const handleChange = (e) => {
    ...
    setForm((prev) => {
      ...
      if (name === "tokenPaymentDueDate" || name === "paymentPlanDays") {
        const tokenDate = name === "tokenPaymentDueDate" ? value : newForm.tokenPaymentDueDate;
        const planDays = name === "paymentPlanDays" ? parseInt(value) : parseInt(newForm.paymentPlanDays);
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="mb-8 pt-16">
          ...
          <p className="text-sm text-neutral-400 mt-1">
            Set token payment date and payment plan days — milestone dates will auto-calculate
          </p>
        </div>
          ...
          {SECTIONS.map((section) => {
            ...
            return (
              <div key={section}>
                ...
                >
                  {sectionFields.map(({ key, label, type = "text", placeholder, readonly }) => (
                    <div key={key}>
                      ...
                      {type === "dropdown" ? (
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          readOnly={readonly}
                          placeholder={placeholder || (type === "text" && key.includes("Date") ? "DD/MM/YYYY" : "Enter value")}
        ...
        <div className="mt-6 p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
          <p className="text-xs text-amber-400">
            💡 <span className="font-semibold">How it works:</span> Enter Token Payment Due Date (DD/MM/YYYY) and Payment Plan Days. 
            The total days will be divided into 3 equal intervals to calculate all milestone due dates automatically.
          </p>
        </div>
