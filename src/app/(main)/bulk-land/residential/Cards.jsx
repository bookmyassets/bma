  ...
  const benefits = [
    {
      ...
      description:
        "Land value may increase due to planned development in the area.",
    },
    {
      id: "flexibility",
      icon: Home,
      ...
      description:
        "The land can be used for residential, commercial, and service purposes.",
    },
    {
      id: "infrastructure",
      icon: Plug,
      ...
      description:
        "Basic infrastructure, like roads and utilities, is already planned or available.",
    },
    {
      id: "community",
      icon: Users,
      ...
      description:
        "The zone is designed with shared spaces and organized layouts.",
    },
    {
      id: "government",
      icon: Landmark,
      ...
      description:
        "Development is supported by government planning and policies.",
    },
  ];
  ...
  const projects = [
    {
      ...
      description:
        "Space can be used for shops, showrooms, and local businesses.",
    },
    {
      id: "hospitality",
    ...
    },
    {
      ...
      description:
        "Land can be used for clinics, wellness centers, and medical services.",
    },
    {
      id: "education",
      icon: GraduationCap,
      ...
      description:
        "Suitable for schools, training centers, and community spaces.",
    },
    {
      id: "residential",
      icon: Home,
      ...
      description:
        "Can be developed for homes, apartments, or residential buildings.",
    },
  ];
