  ...
  return (
    ...
    <meta
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[100vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 sm:p-6 max-w-md w-full">
            ...
            >
              Book Your Plot In Dholera Starting ₹8 Lakh
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row px-4 md:px-8 py-12 md:py-20 gap-6 md:gap-12 max-w-7xl mx-auto">
          ...
          <div className="w-full md:w-3/5 pl-2 pr-2 space-y-6">
            <p className="text-base md:text-lg font-light leading-relaxed text-gray-600">
              Marina Bay is a premium plotting project located in Village Gamph,
              Tehsil Dholera, District Ahmedabad, right within the developing
              Dholera Smart City (Dholera SIR). Strategically placed near the
              ahmedabad dholera expressway and the proposed Dholera
              International Airport, Marina Bay offers legally secure Dholera
              residential plots with clear titles and registry-ready approvals.
              Designed as part of India’s first Greenfield Smart City, the
              project blends modern lifestyle amenities with long-term
              investment growth.
            </p>
      ...
      <div className="pt-4 pb-4">
        ...
        <CostSheet projectSlug="marina-bay" showProjectSelector={false} />
      </div>
