  ...
  const amenities = [
    {
      ...
      description: "A common area for meetings, work, and social activities with modern facilities.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Gated Community",
      color: "from-indigo-500 to-purple-600",
      description: "A secure gated entry ensures controlled access and privacy for residents.",
    },
    {
      icon: <Car className="w-8 h-8" />,
      title: "EV Charging Station",
      color: "from-green-500 to-emerald-500",
      description: "A charging facility for electric vehicles to support eco-friendly living.",
    },
    {
      icon: <Baby className="w-8 h-8" />,
      title: "Kids Play Area",
      color: "from-purple-400 to-pink-400",
      description: "A dedicated play zone for children with safe and fun recreational equipment.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "24/7 Security & CCTV Surveillance",
      color: "from-red-500 to-red-700",
      description: "Round-the-clock security with CCTV monitoring for a safe and protected living environment.",
    },
    {
      icon: <Waves className="w-8 h-8" />,
      title: "Swimming Pool",
      color: "from-blue-400 to-blue-600",
      description: "A clean pool for relaxation and swimming with proper maintenance.",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "App-based Society Management",
      color: "from-teal-500 to-teal-700",
      description: "Society services and communication are managed efficiently through a mobile app.",
    },
    {
      icon: <Trees className="w-8 h-8" />,
      title: "Lush Green Surroundings",
      color: "from-green-600 to-green-800",
      description: "Green areas and plants around the project for a fresh environment and natural beauty.",
    },
    {
      icon: <Baby className="w-8 h-8" />,
      title: "Indoor Games & Gymnasium",
      color: "from-purple-500 to-pink-500",
      description: "Space for indoor games and basic fitness activities with modern equipment.",
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Automated Street Light",
      color: "from-yellow-500 to-orange-500",
      description: "Street lights that turn on and off automatically for energy efficiency and safety.",
    },
    {
      icon: <Activity className="w-8 h-8" />,
      title: "Jogging Track",
      color: "from-orange-500 to-red-500",
      description: "A dedicated jogging path for fitness and daily exercise within the project.",
    },
    {
      icon: <MapPin className="w-8 h-8" />,
      title: "Internal Roads",
      color: "from-gray-600 to-gray-800",
      description: "Well-planned roads inside the project for easy and safe movement.",
    },
    {
      icon: <Home className="w-8 h-8" />,
      title: "Project Boundary",
      color: "from-gray-500 to-gray-700",
      description: "The project is fully enclosed with a defined boundary for better security and organized development.",
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Yoga Deck & Senior Citizen Zone",
      color: "from-pink-500 to-rose-500",
      description: "Serene outdoor space for yoga and wellness, plus a comfortable area for elderly residents.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Power & Water Supply",
      color: "from-yellow-600 to-yellow-800",
      description: "Reliable and uninterrupted electricity and water supply for daily convenience.",
    },
  ];
