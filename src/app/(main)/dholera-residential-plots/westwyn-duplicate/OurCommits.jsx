  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="space-y-4 md:space-y-8 h-full p-4">
        ...
        >
          <p className="text-white text-center text-[clamp(1.5rem,3vw,2.25rem)] py-4 font-semibold">
            Our Commitments
          </p>
      ...
      ${i === 4 ? "col-span-2 md:col-span-1" : ""}`}
                >
                  <div className="text-[clamp(1.125rem,2vw,1.5rem)] flex justify-center items-center font-bold text-[#ddbc69] leading-tight mb-2">
                    {value}
                  </div>
                </div>
              ))}
