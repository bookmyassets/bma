    ...
    <div className="bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="text-center mb-4 space-y-2">
          <h1 className="text-[clamp(1.5rem,3vw,2.25rem)] font-bold text-[#ddbc69]">
            WestWyn Residency{" "}
          ...
          <p className="text-[clamp(0.95rem,1.4vw,1.125rem)] text-gray-600 max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto py-4">
          <div>
            <h2 className="text-[clamp(1.5rem,3vw,2.25rem)] font-semibold text-center ">
              Prime Location
            </h2>
          </div>
          <div className="grid md:grid-cols-2 py-4 max-sm:space-y-4">
            ...
            <div className="bg-gray-100 text-[clamp(0.95rem,1.4vw,1.125rem)] p-4 rounded-xl">
