    ...
    <div className="bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div>
            <h3 className="text-[clamp(1.5rem,3vw,2.25rem)] font-semibold text-center ">
              Plan Layout
            </h3>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 p-3 sm:p-4 lg:p-5">
                      {/* Title */}
                      <span
                        className="font-bold text-center w-full text-[clamp(0.875rem,1.25vw,1rem)]"
                      ...
                      <div className="flex flex-1 items-center justify-center">
                        <span
                          className={`font-semibold ${align} text-[clamp(0.875rem,1.25vw,1rem)] leading-snug`}
                          style={{ color: "#1a1a1a" }}
                        >
                          {content}
                        </span>
