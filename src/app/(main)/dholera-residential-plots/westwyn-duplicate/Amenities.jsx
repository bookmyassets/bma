...
const AmenityCard = ({ amenity }) => (
  ...
  >
    ...
    <h3
      className="font-semibold leading-snug text-[clamp(0.875rem,1.25vw,1rem)]"
      style={{ color: "#0d0d0d" }}
    >
      {amenity.title}
    </h3>
      ...
      <div className="bg-white py-4 sm:py-10 lg:py-4 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4 sm:mb-4 lg:mb-8">
            <p
              className="font-bold tracking-[0.25em] uppercase mb-3 text-[clamp(1.25rem,2.5vw,2rem)]"
              style={{ color: "#ddbc69" }}
            >
              WestWyn Residency
            </p>
            <h4
              className="font-bold mb-4 text-[clamp(1.5rem,3vw,2.25rem)]"
