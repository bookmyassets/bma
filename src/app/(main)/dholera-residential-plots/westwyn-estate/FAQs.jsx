      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "WestWyn Estate starts from ₹10 Lakh, with plot sizes ranging between 151 and 198 square yards.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "You can reserve your plot with a token amount of ₹50,000. After booking, clients receive a free site visit. Once payment is complete, the legal process begins and registry papers are sent via speed post.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "With the upcoming Dholera International Airport and the Tata Semiconductor Plant, Dholera is emerging as India’s semiconductor hub, driving rapid land value appreciation and residential demand.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "BookMyAssets supports plot selection in Dholera, legal verification, and the complete booking process, ensuring a secure and hassle-free investment experience.",
          },
        },
      ],
    }),
