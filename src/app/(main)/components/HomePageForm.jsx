...
export default function LeadFormhomepage({ title, button }) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-[#B3000C] placeholder-gray-400"
                  ...
                  <button
                    ...
                    className={`w-auto font-bold py-3 px-6 rounded-lg transition-all duration-300 ${
                      isLoading || isDisabled || !recaptchaLoaded
                        ...
                        : "bg-white text-[#B3000C] shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    }`}
                  >
                    {isLoading ? (
