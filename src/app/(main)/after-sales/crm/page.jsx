...
const cards = [
  {
    ...
    description: "View and download all payment receipts",
    href: "/after-sales/crm/payment-receipt",
    icon: "🧾",
  },
  {
    title: "Payment Schedule",
    description: "Track upcoming and past payment milestones",
    href: "/after-sales/crm/payment-schedule",
    icon: "📅",
  },
];
