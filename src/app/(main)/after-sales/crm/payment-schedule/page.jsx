...
const FIELDS = [
  ...
  {
    key: "bookingPaymentDueDate",
    label: "Booking Payment Due Date",
...
export default function PaymentSchedulePage() {
  ...
  const handleChange = (e) => {
    ...
    setForm((prev) => {
      ...
      if (name === "bookingPaymentDueDate" || name === "paymentPlanDays") {
        const tokenDate =
          name === "bookingPaymentDueDate" ? value : newForm.bookingPaymentDueDate;
