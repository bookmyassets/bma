...
import { FaDownload, FaMapMarkerAlt, FaVideo, FaBuilding, FaRocket, FaCity, FaIndustry, FaPlane } from "react-icons/fa";
  ...
  <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-3xl shadow-2xl border border-amber-200 mb-12">
    <div className="text-center mb-8">
      <h2 className="text-3xl md:text-4xl font-black text-gray-800 mb-4">
        Why Dholera is the <span className="text-amber-600">Future of India</span>
      </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-6">
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">🚀 Government Backing</h3>
          <p className="text-gray-700">First greenfield smart city in India with complete government support and infrastructure development.</p>
        </div>
        
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">✈️ International Airport</h3>
          <p className="text-gray-700">Upcoming international airport making it a global business hub with direct connectivity.</p>
        </div>
        
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">🏭 Industrial Hub</h3>
          <p className="text-gray-700">Major industries like automotive, textiles, and IT are setting up operations here.</p>
        </div>
      </div>
      
      <div className="space-y-6">
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">🌆 Smart Infrastructure</h3>
          <p className="text-gray-700">World-class infrastructure with smart utilities, metro connectivity, and modern amenities.</p>
        </div>
        
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">💰 Investment Returns</h3>
          <p className="text-gray-700">Land prices expected to appreciate 10-15x in the next 5-7 years as development progresses.</p>
        </div>
        
        <div className="bg-white/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
          <h3 className="text-xl font-bold text-gray-800 mb-3">🎯 Strategic Location</h3>
          <p className="text-gray-700">Located between Delhi-Mumbai Industrial Corridor (DMIC) with excellent connectivity.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-16">
        ...
        >
          ...
          <div className="pt-6">
            ...
            >
              <FaDownload className="group-hover:animate-bounce text-2xl" aria-hidden="true" />
        ...
        <section aria-labelledby="features-heading" className="pt-8">
          <div className="text-center mb-12">
            <h2 id="features-heading" className="text-3xl md:text-4xl font-black text-gray-800 mb-4">
...
<section aria-labelledby="updates-heading" className="pt-16">
  <div className="text-center mb-12">
    ...
    >
      ...
      <br />
      <span className="text-lg md:text-2xl font-semibold">Premium Residential Plots</span>
    </h2>
  </div>
    ...
    {subProjectInventory.length > 0 ? (
      ...
      <div className="col-span-full text-center p-12 bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-amber-200/50">
        <p className="text-gray-700 text-xl font-medium">
          New projects coming soon. Stay tuned for exciting opportunities!
        </p>
      </div>
    )}
  </div>
        ...
        <section className="pt-16">
          <div className="text-center mb-12">
            ...
            >
              ...
              <br />
              <span className="text-lg md:text-2xl font-semibold">India's Smart City Vision</span>
            </h2>
          </div>
        ...
        <section className="pt-16">
          <div className="text-center mb-12">
            ...
            >
              ...
              <br />
              <span className="text-lg md:text-2xl font-semibold">Dholera Development Updates</span>
            </h2>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-amber-200/50">
            <BrowseBlogs />
