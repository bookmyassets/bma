...
export default function ProjectSlider() {
  ...
  const totalSlides = Math.max(1, residentialProjects.length - cardsPerView + 1);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-white text-lg max-w-2xl mx-auto">
              Discover exceptional residential opportunities crafted for modern living
            </p>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative h-48 bg-gradient-to-r from-[#deae3c]/20 to-[#deae3c]/10 flex items-center justify-center overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 bg-[#deae3c] text-black px-3 py-1 rounded-full text-sm font-semibold z-10">
                        Featured
                      </div>
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      ...
                      <div className="space-y-2 mb-2">
                        ...
                        <div className="flex items-center text-gray-800">
                          ...
                          <span className="text-sm">
                            {project.plots || project.numberOfPlots || 'Multiple'} Plots
                          </span>
                        </div>
                      ...
                      <p className="text-gray-600 text-sm mb-4 line-clamp-3 flex-grow">
                        {project.description || 'Experience luxury living with modern amenities and exceptional design in this premium residential project.'}
                      </p>

                      <button
                        onClick={() => openProjectForm(project)}
                        className="w-full bg-[#deae3c] hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300 mt-auto"
                      >
                        More Info
                      </button>
                    </div>
