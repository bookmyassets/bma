...
export default function Dholeravideos() {
  ...
  const prevSlide = () => {
    setCurrentSlide(prev => prev === 0 ? Math.ceil(videos.length / 3) - 1 : prev - 1);
    setIsAutoplay(false);
  };
  ...
  const visibleVideos = videos.slice(currentSlide * 3, (currentSlide * 3) + 3);
        ...
        <div className="relative pt-8">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="relative">
              ...
              <button
                onClick={prevSlide}
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#deae3c] hover:bg-[#c49a2f] text-white p-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110"
              ...
              <button
                onClick={nextSlide}
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#deae3c] hover:bg-[#c49a2f] text-white p-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110"
                disabled={totalSlides <= 1}
              >
                  ...
                  {Array.from({ length: totalSlides }, (_, slideIndex) => (
                    <div key={slideIndex} className="w-full flex-shrink-0">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-12">
                        {videos.slice(slideIndex * 3, (slideIndex * 3) + 3).map((video, index) => {
