...
const projects = [
  ...
  },
  {
    id: 2,
    name: "Paradise",
    description: "Luxurious living spaces with scenic surroundings",
    image: paradise,
    status: "Sold Out"
  },
  {
    ...
    <div className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="relative">
              ...
              <p className="text-gray-600 text-lg mb-6">
                Over 5+ projects successfully sold out in Dholera Smart City. BookMyAssets 
                proudly presents Dholera's most premium projects with unmatched quality and value.
              </p>
              <div className="mt-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl text-[#d7b36c] font-bold">WestWyn County</p>
                  </div>
                </div>
              </div>
                  ...
                  {projects.map((_, index) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all ${
                        currentSlide === index ? "w-8 bg-[#d7b36c]" : "w-2 bg-gray-300"
                      }`}
          ...
          <div className="relative overflow-hidden rounded-xl h-96 md:h-[500px] shadow-2xl"
