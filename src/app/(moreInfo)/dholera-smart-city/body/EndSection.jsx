...
export default function EndSection() {
  ...
  return (
    <>
      ...
      <div className="w-full pt-4 pb-4 bg-gradient-to-r from-[#ddbc69] to-[#c4a055]">
        <section className="max-w-7xl mx-auto px-4">
          ...
          <div className=" p-6  rounded-lg text-black">
            ...
            <button
              ...
              className=" bg-white text-[#ddbc69] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Enquire Now
            </button>
          </div>
