...
export default function BrochureDownload({
  ...
  // PDF download URL
  const pdfUrl =
    "https://cdn.sanity.io/files/c3e1h345/projects/9f32c6d0d835cfc039e42a741e63894f87fd48ce.pdf";
          ...
          >
            ...
            {showPopup ? (
              <div className="text-center py-8">
                ...
                <p className="text-[#ddbc69] text-sm mt-2">
                  Your brochure is downloading...
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <motion.button
                  ...
                  id="brochurex"
                  className="trackerx w-full py-3 px-6 bg-gradient-to-r from-[#ddbc69] to-[#ddbc69] text-black rounded-lg hover:from-[#ddbc69] hover:to-[#ddbc69] transition-all shadow-lg hover:shadow-[#ddbc69]/20 font-semibold disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading
                    ? "Verifying..."
                    : recaptchaLoaded
