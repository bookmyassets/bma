  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="container mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-8">
          {/* Left Content */}
          <div className="flex flex-col justify-center space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#FDB913] to-[#C69C21]">
              Your Perfect Investment Opportunity
            </h1>
            <p className="text-base md:text-xl max-w-xl text-transparent bg-clip-text bg-gradient-to-r from-white/90 to-[#FDB913]/90">
            ...
            <div className="flex space-x-4 pt-4">
              <Link
                href="/pages/investments"
                className="px-6 py-2 bg-yellow-500 text-black rounded-full hover:bg-yellow-600 transition text-sm md:text-base"
              >
                Explore Investments
              </Link>
              <Link
                href="#contact-form"
                className="px-6 py-2 border border-white rounded-full hover:bg-white hover:text-black transition text-sm md:text-base text-white"
              >
                Contact Us
              </Link>
            </div>
          ...
          <div
            id="contact-form"
            className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-xl shadow-2xl border border-gray-700 max-w-md w-full mx-auto"
          >
      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-4 z-20">
        <a
